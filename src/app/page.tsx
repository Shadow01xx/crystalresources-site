  ...
  return (
    <>
      ...
      <div className="w-full h-auto py-2 px-4 bg-[var(--primary)] flex flex-col md:flex-row items-center justify-center text-center gap-3">
        <h1 className="text-black/50 text-base md:text-xl">Ganhe 25% de desconto em nossa loja utilizando o cupom</h1>
        <div className="flex items-center gap-2">
          <div className="px-3 py-1 bg-black/10 rounded-sm">
            <h1 className="text-black/50 text-lg">CRYSTAL25%</h1>
          </div>
        ...
        <section className="flex flex-col w-[90%] md:w-[80%] mx-auto items-center text-center mt-20 md:mt-[160px]">
          <div className="max-w-[756px]">
            <div className="flex flex-wrap justify-center gap-2">
              {["#CRYSTAL25%", "#TOP 1", "#BR"].map((tag, i) => (
                <div key={i} className="px-4 py-2 border border-white/20 rounded-lg">
                  <h2 className="text-white/35">{tag}</h2>
                </div>
              ))}
            </div>
            <h1 className="text-[var(--primary)] text-[40px] sm:text-[50px] md:text-[65px] font-bold mt-4">CRYSTAL RESOURCES</h1>
            ...
            <div className="flex gap-4 mt-8 justify-center">
              {[FaDiscord, FaYoutube].map((Icon, i) => (
      ...
      <div id="sobre" className="w-full bg-white/1 border-y border-white/5 py-12 px-4">
        <div className="w-full max-w-[1240px] mx-auto text-center">
          ...
          <p className="text-white/35 text-base sm:text-lg md:text-xl mt-4">
            Somos a Crystal Resources, especialistas em criar scripts e sistemas otimizados para servidores MTA. Nosso foco é entregar qualidade, desempenho e suporte sempre disponível, garantindo que sua experiência seja completa do começo ao fim.
          </p>

          <div className="flex flex-col lg:flex-row gap-6 justify-center items-center mt-10">
            {[
              { Icon: GoPerson, title: "Clientes", desc: "Atualmente estamos com", value: "0 clientes" }, 
              { Icon: FiBox, title: "Produtos", desc: "Temos disponíveis", value: "2 produtos" }, 
              { Icon: IoMdCart, title: "Vendas", desc: "Realizamos mais de", value: "0 vendas" }
      ...
      <footer className="bg-[#0e0e0e] border-t border-white/10 mt-[100px]">
        <div className="flex flex-col md:flex-row justify-between items-center w-[90%] md:w-[80%] mx-auto py-6 text-white/40 text-sm">
          <div className="mb-4 md:mb-0 text-white/50 text-[15px] font-medium">Crystal Resources | © 2025 — A referência em vendas e serviços para o MTA</div>
